  ...
  det.innerHTML = `
    <div class="cid-wrap" style="--cp:${c.color}">
      ...
      <div class="cid-body">
        ...
        <!-- PRIMARY KPIs -->
        <div class="cid-section-title">📊 Core Market Metrics</div>
...
function closeCountry() {
  ...
  const countriesPage = document.getElementById('page-countries');
  if(countriesPage) countriesPage.classList.remove('country-theme');
  currentCode = null;
  currentNet = null;
}
...
(function initDashboardModules(){
  try { buildCountryCards(); } catch(e) { console.error("Country cards init failed", e); }
  try { buildDistributors(); } catch(e) { console.error("Distributor init failed", e); }
  try { buildKols(); } catch(e) { console.error("KOL init failed", e); }
})();
