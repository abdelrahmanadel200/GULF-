...
for i,row in enumerate(_cr):
    ...
    if key in _cmap:
        ...
        for rr in _cr[i+2:]:
            ...
            arr.append({"name":rr[0],"share":rr[1],"coverage":rr[2],"weakness":rr[3],
